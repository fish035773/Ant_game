...
Scene *New_Menu(int label)
{
    ...
    pDerivedObj->font = al_load_ttf_font("assets/font/pirulen.ttf", 8, 0);
    // Load sound
...
void menu_draw(Scene *self)
{
    ...
    al_draw_rectangle(Obj->title_x - 80, Obj->title_y - 16, Obj->title_x + 80, Obj->title_y + 16, al_map_rgb(255, 255, 255), 0);
